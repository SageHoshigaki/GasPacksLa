...
export default function WeedHeroSection() {
  return (
    <section className="relative bg-black overflow-hidden text-white">
      ...
      {/* headline block */}
      <div className="mx-auto max-w-7xl min-w-0 px-4 sm:px-6 md:px-8 py-16 sm:py-20 md:py-24">
        ...
        <h1 className="mt-8 sm:mt-10 font-extrabold leading-[1.05] text-[clamp(2.5rem,6vw,5rem)] break-words">
